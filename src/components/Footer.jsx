        ...
        <div className="footer-container">
          ...
          <div className="footer-brand">
            <div className="footer-logo-row">
              ...
              <span className="footer-brand-name">MharooMedia</span>
            </div>
            <p className="footer-desc">
              We are a premium digital agency dedicated to building, scaling, and making brands stand out through innovative and data-driven strategies.
            </p>
